        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tags", x => new { x.Name, x.StudentId });
                    table.ForeignKey(
                        name: "FK_Tags_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<int>(type: "INTEGER", maxLength: 36, nullable: false),
                    TeacherId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    StudentId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    HomeworkTaskId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentHomeworkTasks", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentHomeworkTasks_HomeworkTasks_HomeworkTaskId",
            ...
            migrationBuilder.CreateTable(
                name: "StudentHomeworkTaskTag",
                columns: table => new
                {
                    StudentHomeworkTasksId = table.Column<int>(type: "INTEGER", nullable: false),
                    TagsName = table.Column<string>(type: "TEXT", nullable: false),
                    TagsStudentId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentHomeworkTaskTag", x => new { x.StudentHomeworkTasksId, x.TagsName, x.TagsStudentId });
                    table.ForeignKey(
                        name: "FK_StudentHomeworkTaskTag_StudentHomeworkTasks_StudentHomeworkTasksId",
                        column: x => x.StudentHomeworkTasksId,
                        principalTable: "StudentHomeworkTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentHomeworkTaskTag_Tags_TagsName_TagsStudentId",
                        columns: x => new { x.TagsName, x.TagsStudentId },
                        principalTable: "Tags",
                        principalColumns: new[] { "Name", "StudentId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Todos_StudentHomeworkTasks_StudentHomeworkTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentHomeworkTasks_HomeworkTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentHomeworkTaskTag_TagsName_TagsStudentId",
                table: "StudentHomeworkTaskTag",
                columns: new[] { "TagsName", "TagsStudentId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tags_StudentId",
                table: "Tags",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Todos_StudentHomeworkTaskId",
                table: "Todos",
